...
//        view.addSubview(tableView)
        ...
        collectionView.register(MyCollectionViewCell.self, forCellWithReuseIdentifier: "cell")  // reuseIdentifier는 내가 기억하기로, 스토리보드 혹은 코드로 지정을 해야했다.
...
//    }
    ...
    // CollectionView cell은 클래스로 정의를 해야한다. -> 오호!
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! MyCollectionViewCell // 여기에서 타입 변환을 했으니
        cell.imageView.image = images[indexPath.item]
        return cell
    }
    
    // MARK: - UICollectionViewDelegateFlowLayout 꺼
